...
public class Sample extends EnumValueItemImpl {
	...
	public String toString() {
		return "Sample{" +
				...
				", enteredDateForDisplay='" + enteredDateForDisplay + '\'' +
				", receivedTimestamp=" + receivedTimestamp +
				", receivedDateForDisplay='" + receivedDateForDisplay + '\'' +
				", receivedTimeForDisplay='" + receivedTimeForDisplay + '\'' +
				", referredCultureFlag='" + referredCultureFlag + '\'' +
				", collectionDate=" + collectionDate +
				", collectionDateForDisplay='" + collectionDateForDisplay + '\'' +
				", collectionTimeForDisplay='" + collectionTimeForDisplay + '\'' +
				", clientReference='" + clientReference + '\'' +
				", status='" + status + '\'' +
				", releasedDate=" + releasedDate +
				", releasedDateForDisplay='" + releasedDateForDisplay + '\'' +
				", stickerReceivedFlag='" + stickerReceivedFlag + '\'' +
				", sysUserId='" + sysUserId + '\'' +
				", barCode='" + barCode + '\'' +
				", transmissionDate=" + transmissionDate +
				", transmissionDateForDisplay='" + transmissionDateForDisplay + '\'' +
