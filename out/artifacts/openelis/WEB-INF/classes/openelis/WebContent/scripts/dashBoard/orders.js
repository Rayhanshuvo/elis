...
function generateLinkForCustomPrint(order){
    var printMessage = jQuery("#translatedColumnNames").attr("data-link-customPrint");
    var printIcon = '<img id="actionIcon" src="images/custom-print.png" title="'+ printMessage +'">';
    return "<a id='result' href='CustomReport.do?accessionNumber=" + order.accessionNumber + "&referer=LabDashboard"+"'>"+printIcon+"</a>";
}
...
function getColumnsForBacklogOrder(alwaysValidate) {
    if (alwaysValidate) {
        return [
            ...
            {id:"pendingValidationCount", name:jQuery("#translatedColumnNames").attr("data-pendingValidation"), field:"pendingValidationCount", sortable:true, editor:Slick.Editors.Text, index:5, searchable:false, minWidth:140},
            {id:"totalTestCount", name:jQuery("#translatedColumnNames").attr("data-total"), field:"totalTestCount", sortable:true, editor:Slick.Editors.Text, index:6, searchable:false, minWidth:50},
            {id:"notes", name:jQuery("#translatedColumnNames").attr("data-notes"), field:"comments", sortable:true, index:7, searchable:false, editor:Slick.Editors.Text, minWidth:250},
