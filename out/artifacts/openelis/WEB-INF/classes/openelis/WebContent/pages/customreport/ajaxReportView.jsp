...
<div id="divprint">
    <table style="border-collapse: collapse;  border-radius: 10px; box-shadow: 0 0 0 1px #666; color: black"
           width="99%">
    ...
    <table style="border-collapse: collapse;" width="99%">
        ...
        <c:forEach items="${analysisList}" var="ana" varStatus="index">
            <tr>
                <td><c:out value="${ana.test.testName}"/> <> <c:out value="${ana.panel.panelName}"/></td>
                <td>
