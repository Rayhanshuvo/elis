...
<bean:define id="todaySampleNotCollectedListJson
" name="<%=formName%>" property="todaySampleNotCollectedList" />
...
<div>
    ...
    <span id = "translatedColumnNames"
        ...
        data-link-customPrint = '<bean:message key="dashboard.sample.column.link.custom.print"/>'
    ></span>
    <div id="tabs">
